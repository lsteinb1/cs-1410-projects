...
class ToUpperTest {
	...
	void toUpper_blankBeforeLetter() {
		assertEquals("  A", Recursion.toUpper(" A", 0));
	}
	...
	void toUpper_blankBetweenLetters() {
		assertEquals("A   B", Recursion.toUpper("A B", 0));
	}
	...
	void toUpper_3lowerCaseLetters() {
		assertEquals("A B C", Recursion.toUpper("abc", 0));
	}
	
	@Test
	void toUpper_nonLetters() {
		assertEquals("& 2 *", Recursion.toUpper("&2*", 0));
	}
	
	@Test
	void toUpper_emptyString() {
		assertEquals("", Recursion.toUpper("", 0));
	}

	@Test
	void toUpper_mixedCaseLetters() {
		assertEquals("F I R S T A N D L A S T", Recursion.toUpper("fIRSTandLASt", 0));
	}

	@Test
	void toUpper_randomCharacters() {
		assertEquals("H # E % L L O ^ T H ;   E ^ R E", Recursion.toUpper("h#e%LlO^Th; e^RE", 0));
	}
}
